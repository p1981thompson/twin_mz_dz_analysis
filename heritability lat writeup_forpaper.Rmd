...
doubledata$peak2cat <-doubledata$peak_latcat
w<-which(doubledata$peak2cat<0)
doubledata$peak2cat[w]<-0 #combines bilateral and R
doubledata$peak2cat2 <-doubledata$peak_latcat2
w<-which(doubledata$peak2cat2<0)
doubledata$peak2cat2[w]<-0 #combines bilateral and R

df = doubledata # for ease of typing
#Need to rename columns to fit umx syntax
mycols<-c("ehp_handedness", "qhp_handedness", "lat_index","peakLI","peak2cat","mean_left_flow","mean_right_flow")
...
m1 = umxACE("peak2cat", selDVs = "peak2cat", sep="_T", mzData = mzData, dzData= dzData)
m2 = umxModify(m1, "c_r1c1", name="ae", comparison= TRUE) #drop C term - this is our starting model
m3 = umxModify(m2, "a_r1c1", name="e", comparison= TRUE)
umxCompare(m2, m3)
umxSummary(m2)
