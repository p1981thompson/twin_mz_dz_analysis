...
ft2<-flextable(data = tdftable) %>% 
  theme_booktabs( include.rownames = TRUE) %>% 
  set_header_labels( c('Edinburgh Handedness','QHP','Language LI' ))
