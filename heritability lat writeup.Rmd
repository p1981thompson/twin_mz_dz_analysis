...
makescatter <- function(mytitle,xpos,ypos,filetitle,vline){
ggscatter(doubledata[1:singlerows,], x = 'myx', y = 'myy',  xlab='Twin 1',ylab='Twin 2',
                 shape = "Zygosity"    ,                         # Change point shape by groups 
            color = "Zygosity", palette = get_palette("aaas", 2),           # Color by groups 
            title = mytitle
          )+
  stat_cor(aes(color = Zygosity), label.x = xpos,label.y=ypos,method='spearman',show.legend=FALSE) +
  geom_vline(xintercept=vline,linetype="dashed")+geom_hline(yintercept = vline,linetype="dashed") 
...
#EHI plot
myjitter<-rnorm(nrow(doubledata))/3
...
xpos<-3 #coordinates for correlation on plot
ypos<-c(1,2)
filetitle<-'ehiplot.png'
vline=5.5
makescatter(mytitle,xpos,ypos,filetitle,vline)
...
xpos<-0 #coordinates for correlation on plot
ypos<-c(7,5)
...
xpos<-4 #coordinates for correlation on plot
ypos<-c(10,9)
...
g1 <- ggscatter(doubledata[1:singlerows,], x = 'myx', y = 'myy',  xlab='Twin 1',ylab='Twin 2',
                 shape = "Zygosity", color = "Zygosity", palette = get_palette("aaas", 2),           
...
g2 <- ggscatter(doubledata[1:singlerows,], x = 'myx', y = 'myy',  xlab='Twin 1',ylab='Twin 2',
                 shape = "Zygosity", color = "Zygosity", palette = get_palette("aaas", 2),           
            title = 'Quantification of Hand Preference')+
  stat_cor(aes(color = Zygosity), label.x = xpos,label.y=ypos,method='spearman',show.legend=FALSE) +
  geom_vline(xintercept=vline,linetype="dashed")+geom_hline(yintercept = vline,linetype="dashed")
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
w<-which(doubledata$doppout==1)
...
g3 <- ggscatter(doubledata[1:singlerows,], x = 'myx', y = 'myy',  xlab='Twin 1',ylab='Twin 2',
                 shape = "Zygosity", color = "Zygosity", palette = get_palette("aaas", 2),           
            title = 'Laterality Index (fTCD)')+
  stat_cor(aes(color = Zygosity), label.x = xpos,label.y=ypos,method='spearman',show.legend=FALSE) +
  geom_vline(xintercept=vline,linetype="dashed")+geom_hline(yintercept = vline,linetype="dashed")
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
