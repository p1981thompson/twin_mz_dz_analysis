...
makescatter <- function(mytitle,xpos,ypos,filetitle){
ggscatter(doubledata[1:singlerows,], x = 'myx', y = 'myy',  xlab='Twin 1',ylab='Twin 2',
  ...
  stat_cor(aes(color = Zygosity), label.x = xpos,label.y=ypos,method='spearman') 
...
makescatter(mytitle,xpos,ypos,filetitle)
###########################################################################################
#QHP plot
myjitter<-rnorm(nrow(doubledata))/3
